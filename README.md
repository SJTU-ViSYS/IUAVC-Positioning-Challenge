...
### 更新说明
#### 2022/10.31
1.  调整了实时性判定标准，延时需求从40ms提升至70ms,有效帧占图像总帧数的比例由70%降低至50%;
2.  补充测试数据集seq3~seq6;
...
seq7: https://intelligent-uav-championship.oss-cn-shanghai.aliyuncs.com/dataset/IntelligentUAV_seq7.bag<br>
#### 数据说明
