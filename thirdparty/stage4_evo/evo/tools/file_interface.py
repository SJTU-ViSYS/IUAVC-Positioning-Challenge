...
result_obj: result.Result,
    ...
    :param confirm_overwrite: whether to require user interaction
           to overwrite existing files
    """
    zip_path=base_path+"_result.zip"
    with open(base_path+"_result.json","r") as f:
        jsonConent={}
        jsonConent=json.load(f)
        jsonConent.update(result_obj.stats)
    with open(base_path+"_result.json","w") as f:
        json.dump(jsonConent,f)
